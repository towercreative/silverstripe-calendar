...
class EventTest extends SapphireTest
{
    ...
    public function test_summary_fields(): void
    {
    ...
    public function test_event_page_title_no_calendar_page(): void
    {
    ...
    public function test_set_start_end_duration_same_day(): void
    {
    ...
    public function test_set_start_end_duration_more_than_day(): void
    {
        /** @var \TitleDK\Calendar\Events\Event $event */
        $event = $this->objFromFixture(Event::class, 'eventWithDuration');
        $this->assertEquals('2019-10-12 18:00:00', $event->StartDateTime);
    ...
    public function test_set_start_end(): void
    {
        /** @var \TitleDK\Calendar\Events\Event $event */
    ...
    public function test_set_end_after_start(): void
    {
        /** @var \TitleDK\Calendar\Events\Event $event */
        $event = $this->objFromFixture(Event::class, 'eventCricketSeason');
        $this->assertEquals('2020-04-11 12:00:00', $event->StartDateTime);
     ...
     */
    public function test_set_end_before_start(): void
    {
        /** @var \TitleDK\Calendar\Events\Event $event */
        $event = $this->objFromFixture(Event::class, 'eventCricketSeason');
        $this->assertEquals('2020-04-11 12:00:00', $event->StartDateTime);
